...
from Models.CNN.CANet.layers.modules import conv_block, UpCat, UpCatconv, UnetDsv3, UnetGridGatingSignal3
from Models.CNN.CANet.layers.grid_attention_layer import GridAttentionBlock2D, MultiAttentionBlock
from Models.CNN.CANet.layers.channel_attention_layer import SE_Conv_Block
from Models.CNN.CANet.layers.scale_attention_layer import scale_atten_convblock
from Models.CNN.CANet.layers.nonlocal_layer import NONLocalBlock2D


class Comprehensive_Atten_Unet(nn.Module):
    def __init__(self, img_size=(256,256), in_ch=3, n_classes=2, feature_scale=4, is_deconv=True, is_batchnorm=True,
        ...
        # self.out_size = args.data.img_size
...
if __name__ == '__main__':
    ...
    model = Comprehensive_Atten_Unet((256,256),n_classes=1)
